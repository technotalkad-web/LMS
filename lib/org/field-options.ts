 ...
 * that field is MANDATORY on user create/edit/bulk-upload and only listed
 * values are accepted (matched case-insensitively, stored canonically).
 * Fields with an empty list keep the legacy free-text behavior.
 */
